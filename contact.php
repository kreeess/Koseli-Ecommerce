...
<body>
    ...
    <?php @include 'nav.php'?>
        ...
        <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/contact.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
                    ...
                    <div class="col-md-5 col-md-push-1 animate-box">
                        ...
                        <div class="fh5co-contact-info">
                            ...
                            <ul>
                                ...
                                <li class="phone"><a href="tel://1234567920">+977 981-382-2260</a></li>
                                <li class="email"><a href="mailto:koseli00@gmail.com">Koseli00@gmail.com</a></li>
                                <li class="url"><a href="http://localhost/koseli/about.php" target="_blank">koseli.info.np</a></li>
                            </ul>
                        </div>

...
$sql5 = "SELECT COUNT(orderID) FROM orders";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-4"style="font-size: 32px;">Admin</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <img src="./img/koselii.png" style="width:13%;" alt="Koseli Logo">
                </div>
                <pre style="font-size: 35px;text-align: justify; color: lightblack; font-family: cursive" ><b>K O S E L I</b></pre>

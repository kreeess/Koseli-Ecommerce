...
if(isset($_POST["productID"]) && !empty($_POST["productID"])){
    ...
    $update = "UPDATE products SET productName = '$productName', productDesc = '$productDesc', productPrice = '$productPrice', qty = '$productQty', categoryID = '$categoryName'  WHERE productID = '$ID';";
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                <div class="row">
                    ...
                    <img src="../../images/products/<?php echo $productPhoto?>" alt="<?php echo $productName?>" class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width:25rem ;"  >
                </div>
            </div>
        </div>
    </div>
